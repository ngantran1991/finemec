...
if(!defined('_source')) die("Error");
    ...
    if($id!='')
	{
		...
		$listLoaiTinTuc = $row_list;
                ...
                // list all tin tuc
                $d->reset();
		$sql_list_tintuc = "select id,ten$lang as ten, tenkhongdau, mota$lang as mota,noidung$lang as noidung, noibat FROM #_news where type='tintuc' and hienthi=1 and id_danhmuc = $id order by stt,id desc";

					...
					<div class="item_product">
				            <div class="sp_img hover_sang1">
				            	<a href="<?=$com?>/<?=$arr_item[$j]['tenkhongdau']?>-<?=$arr_item[$j]['id']?>.html" title="<?=$arr_item[$j]['ten']?>">
				            		<img src="<?php if($arr_item[$j]['photo']!=NULL) echo 'thumb/205x140/1/'.$link_image.$arr_item[$j]['photo']; else echo 'images/noimage.png';?>" alt="<?=$arr_item[$j]['ten']?>" />
				            	</a>
				            </div>
				            <div class="info">
				            	<div><?=_masanpham?>: <?=$arr_item[$j]['masp']?></div>
				            	<div><?=_hangsanxuat?>: <?=$arr_item[$j]['hsx']?></div>
				            	<div><?=_luotxem?>: <?=$arr_item[$j]['luotxem']?></div>
				            </div>
				            <div class="info2">
				            	...
				            	<?php if(!empty($arr_item[$j]['file'])){ ?>
									<div class="file_down"><a href="<?=_upload_download_l.$arr_item[$j]['file']?>"><?=_tailieukythuat?></a></div>
				            	<?php } ?>
				            </div>
				        <div class="clear"></div>
				    </div>

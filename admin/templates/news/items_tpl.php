...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
      ...
      <tr>
        ...
        <td class="tb_data_small <?php if($_GET['type']!='dichvu' && $_GET['type']!='tuyendung' && $_GET['type']!='hotro') {?> none <?php } ?>"><?=get_main_danhmuc()?></td>
    ...
    <tbody>
        ...
        <td align="center" class="<?php if($_GET['type']!='dichvu' && $_GET['type']!='tuyendung' && $_GET['type']!='hotro') {?> none <?php } ?>">
			<?php

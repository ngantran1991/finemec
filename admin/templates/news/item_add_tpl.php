...
<form name="supplier" id="validate" class="form" action="index.php?com=news&act=save&p=<?=$_REQUEST['p']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
    ...
    <?php if($_GET['type']=='dichvu' or $_GET['type']=='hotro' or $_GET['type']=='tintuc' or $_GET['type']=='tuyendung') {?>
		<div class="formRow">
    ...
    <div class="formRow <?php if($_GET['type']!='dichvu' && $_GET['type']!='tuyendung' && $_GET['type']!='hotro') {?> none <?php } ?>">
    ...
    <div class="formRow">
      ...
      <div class="mt10"><?=_upload_tintuc.$item['fileup']?></div>
    ...
    <?php }?>
 	...
 	<div class="formRow">
        ...
        <div class="formRow">
          <label>Hiển thị menu : <img src="./images/question-button.png" alt="Chọn loại" class="icon_que tipS" original-title="Bỏ chọn để không hiển thị danh mục này ! "> </label>
          <div class="formRight">
